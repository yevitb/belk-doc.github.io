...
#### Alexis Brayan López Matías <a name="id62"></a>

Me agradó el proyecto, considero que la experiencia que nos proporcionó será muy útil en el futuro. La infraestructura de BELK es una herramienta muy poderosa que probablemente muchas empresas utilizan para el procesamiento, búsqueda y análisis de datos; el hecho de que hayamos realizado la implementación de BELK ya nos brinda muchas posibilidades de obtener un trabajo relacionado a la ingesta y procesamiento de datos.

Otro aspecto importante es que este proyecto nos permitió reafirmar los conocimientos adquiridos durante todo el plan de becarios, como por ejemplo la instalación y configuración de servicios Unix/Linux y Windows, correspondiente al módulo uno; programación, configuración de servicios web y bases de datos, correspondiente al módulo dos; pruebas de penetración y configuración de infraestructuras de red, de módulo tres; etc.

En general me agradó bastante, aunque considero que sí poseía una gran complejidad debido a que toda la parte central del proyecto, la cual era la pila BELK, era algo nuevo en lo que debíamos indagar bastante para lograr el objetivo final. Adicionalmente, la situación de pandemia en la que nos encontramos añade mayor complejidad, sobre todo en la parte de la comunicación y coordinación con el equipo.

#### Abisinia Ivey Fernández Martínez<a name="id63"></a>

La realización de este proyecto ayudó a reafirmar conocimientos obtenidos y la aplicación de los proyectos, tareas y prácticas en un ambiente completo, para lo cual se realizó la instalación de distintos servicios. Se realizó la instalación y configuración de una herramienta usada por distintas empresas que en un futuro cercano podríamos utilizar, lo que abre nuestro panorama sobre las herramientas para la centralización de Logs, además de la configuración de los servicios habilitación de logs, entre otros que conlleva la centralización.

De entre las ventajas del centralizado de logs me parece muy interesante el que se puedan visualizar distintos eventos sin tener que revisar cada uno de los equipos involucrados, de esta forma creo más fácil el poder detectar anomalías dentro de la red, encontrar el o los servicios implicados y poder rastrear el origen solo mirando las gráficas creadas, es decir si en la gráfica a través del tiempo, muestra demasiadas peticiones incorrectas en un periodo corto de tiempo, se puede identificar un posible ataque, desde cuál IP fue el origen de este ataque e incluso conocer desde cuál país.

#### Luis Fernando Resendiz Cruz<a name="id64"></a>

Consideró que el proyecto final cumple con su objetivo principal que es el poner en práctica todos los conocimientos adquiridos durante todo el plan de becarios con el agregado de aprender sobre temas y herramientas que no se tuvieron la oportunidad de abordar con mayor profundidad durante el plan. Por otro lado, debido a las circunstancias que se viven actualmente tengo una idea que fue más complicada en comparación a si estuviésemos de manera presencial, pero eso también nos deja una enseñanza de tener un mayor conocimiento sobre las opciones para trabajar de manera remota.

Además aprendimos sobre una herramienta que es utilizada en la industria la cual es internarse en su funcionamiento de centralizar logs para su posterior análisis y alertamiento de actividades posiblemente maliciosas. Esta parte fue la más complicada debido a que no se tenía conocimiento sobre la herramienta.

#### Abraham Iván Luna Castañeda<a name="id65"></a>

El proyecto fue, sin duda, una gran experiencia de aprendizaje pues me hizo recordar los temas vistos durante el plan de becarios. Entendí la importancia de documentar los proyectos en los cuales uno tiene participación pues esa documentación me hizo ahorrar tiempo en el momento de instalar los servicios que me tocaron y ahora toda la documentación de este proyecto es una gran fuente de información disponible si la llegara a necesitar. También me hizo adquirir habilidades para trabajar y organizarme con un equipo de trabajo de una manera completamente remota pues no pudimos vernos por la pandemia que estamos viviendo.

Por último, lo que más me dejó este proyecto fue el aprendizaje respecto al funcionamiento, configuración,instalación y administración de una pila ELK. Es una herramienta muy útil para el monitoreo de servicios y además es usado por empresas, entonces esto nos deja familiarizados como para saber de que se nos habla cuando el tema sale en el trabajo (acá hablo por experiencia personal)
